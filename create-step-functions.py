...
function_name = 'arn:aws:lambda:eu-west-1:' + account_id + ':function:query-training-status-nt'
workflow_name = 'MyInferenceRoutine_nt'
...
project_name = 'customer-churn-nt-' + dateAsString
# The name used when the Model is created
model_name='customer-churn-model-nt-' + dateAsString
